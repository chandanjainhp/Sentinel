 ...
 * 
 * Used when a new user registers or needs to verify their email address.
 * Sends a 6-digit (or similar) verification code to confirm ownership of the email.
 * 
 * @requires Placeholder: `{verificationCode}` - The OTP or verification code to be displayed.
 */
 ...
 * 
 * Used to notify a user that their password has been successfully changed/reset.
 * Acts as a security alert to ensure the user is aware of the account modification.
 * 
 * @requires Placeholders: None
 */
 ...
 * 
 * Used when a user clicks "Forgot Password" and requests a reset link.
 * Provides a clickable button and a fallback plain-text link.
 * 
 * @requires Placeholder: `{resetURL}` - The frontend deep link used to enter a new password.
 */
 ...
 * 
 * Used specifically for Admin users requesting a password reset via One-Time Password.
 * Sends a secure OTP to the admin's email to verify identity before allowing a password change.
 * 
 * @requires Placeholder: `{resetOTP}` - The numeric or alphanumeric One-Time Password.
 */
